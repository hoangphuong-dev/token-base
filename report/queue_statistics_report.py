...
class QueueStatisticsReport(models.AbstractModel):
    _name = 'report.hospital_queue_management.report_queue_statistics'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        return {
            ...
            'docs': self.env['queue.token'].browse(docids),
            'data': data,
...
class QueueSummaryReport(models.AbstractModel):
    ...
    _inherit = 'report.hospital_queue_management.report_queue_statistics'
